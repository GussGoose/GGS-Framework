...
namespace GGS_Framework
{
    public class Tween
    {
        ...
        public class Config
        {
            ...
            public Config (GameObject gameObject, string id, float startValue, float endValue, float duration) : this (gameObject, id, startValue, endValue, duration, false)
            {
            }
            ...
            public Config (string uniqueId, float startValue, float endValue, float duration) : this (uniqueId, startValue, endValue, duration, false)
            {
            }
