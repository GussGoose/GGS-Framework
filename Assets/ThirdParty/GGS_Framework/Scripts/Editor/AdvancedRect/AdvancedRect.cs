...
namespace GGS_Framework.Editor
{
    public static partial class AdvancedRect
    {
        ...
        /// </summary>
        [Obsolete ("The use of AdvancedRect.AlignRect has been replaced with ExtendedRect.Align and it would be removed soon. You should change all the references to this function.")]
        ...
        /// </summary>
        [Obsolete ("The use of AdvancedRect.ExpandRect has been replaced with ExtendedRect.Expand and it would be removed soon. You should change all the references to this function.")]
