...
namespace GGS_Framework
{
    public static partial class AdvancedRect
    {
        public class Group : Element
        {
            ...
            internal Group (string key, Orientation orientation, SizeType sizeType, float size, Padding padding, bool use, Element[] elements) : base (key, sizeType, size, padding, use)
            {
